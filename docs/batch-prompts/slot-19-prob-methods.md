# Slot 19 — prob-methods (BATCH-NEW)
...
| Updates      | (none)                                                                                                                                                                                                                                                                                                                                 |
| Curator      | `jikun`                                                                                                                                                                                                                                                                                                                                |
| RUN_ID       | `2026-05-20T08-55-c3d609`                                                                                                                                                                                                                                                                                                              |
| Branch       | `curate/BATCH-NEW-prob-methods-2026-05-20T08-55-c3d609`                                                                                                                                                                                                                                                                                |

**Subdomains the session may author into:**

- `probabilistic-methods/bayesian`
- `probabilistic-methods/variational-inference`
- `probabilistic-methods/monte-carlo-sampling`
...
- `probabilistic-methods/probabilistic-other`
...
TERRITORY: probabilistic-methods/bayesian,probabilistic-methods/variational-inference,probabilistic-methods/monte-carlo-sampling,probabilistic-methods/gaussian-processes,probabilistic-methods/graphical-models,probabilistic-methods/spectral-methods,probabilistic-methods/structure-learning,probabilistic-methods/probabilistic-other # comma-separated "domain/subdomain" pairs, e.g. # "optimization/convex,optimization/non-convex,optimization/stochastic,optimization/discrete-combinatorial"
TERRITORY_LABEL: prob-methods # short kebab-case slug for branch name, e.g. "opt-cluster-a"
...
RUN_ID: 2026-05-20T08-55-c3d609 # YYYY-MM-DDTHH-MM-RAND6 (UTC, hyphens, no colons — Windows-safe)
