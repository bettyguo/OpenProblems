...
- **RUN_IDs in committed slot files are stable but stale-looking** (prefix `2026-05-20T05-42`). They are unique strings, not real timestamps. Regenerate with a fresh prefix any time you want today's timestamp baked in.
