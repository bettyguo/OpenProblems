# Slot 17 — opt-classical (BATCH-NEW)
...
| Updates      | (none)                                                                |
| Curator      | `jikun`                                                               |
| RUN_ID       | `2026-05-20T08-15-a1b4e7`                                             |
| Branch       | `curate/BATCH-NEW-opt-classical-2026-05-20T08-15-a1b4e7`              |
...
RUN_ID: 2026-05-20T08-15-a1b4e7 # YYYY-MM-DDTHH-MM-RAND6 (UTC, hyphens, no colons — Windows-safe)
