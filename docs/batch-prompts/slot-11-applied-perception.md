# Slot 11 — applied-perception (BATCH-NEW)
...
| Updates      | (none)                                                                            |
| Curator      | `jikun`                                                                           |
| RUN_ID       | `2026-05-20T17-00-4b5e81`                                                         |
| Branch       | `curate/BATCH-NEW-applied-perception-2026-05-20T17-00-4b5e81`                     |
...
TERRITORY: applications/computer-vision,applications/language-speech,applications/robotics # comma-separated "domain/subdomain" pairs, e.g. # "optimization/convex,optimization/non-convex,optimization/stochastic,optimization/discrete-combinatorial"
TERRITORY_LABEL: applied-perception # short kebab-case slug for branch name, e.g. "opt-cluster-a"
...
RUN_ID: 2026-05-20T17-00-4b5e81 # YYYY-MM-DDTHH-MM-RAND6 (UTC, hyphens, no colons — Windows-safe)
