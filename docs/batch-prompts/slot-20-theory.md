# Slot 20 — theory (BATCH-NEW)

| Field        | Value                                                                                                                                                                                                                                                      |
| ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mode         | `BATCH-NEW`                                                                                                                                                                                                                                                |
| Territory    | theory/dl-theory, theory/learning-theory, theory/rl-planning-theory, theory/optimization-theory, theory/game-theory, theory/probabilistic-theory, theory/online-bandits, theory/active-interactive, theory/domain-adaptation-transfer, theory/theory-other |
| New problems | 16                                                                                                                                                                                                                                                         |
| Updates      | (none)                                                                                                                                                                                                                                                     |
| Curator      | `jikun`                                                                                                                                                                                                                                                    |
| RUN_ID       | `2026-05-20T08-15-d4e71a`                                                                                                                                                                                                                                  |
| Branch       | `curate/BATCH-NEW-theory-2026-05-20T08-15-d4e71a`                                                                                                                                                                                                          |

**Subdomains the session may author into:**

- `theory/dl-theory`
- `theory/learning-theory`
- `theory/rl-planning-theory`
- `theory/optimization-theory`
- `theory/game-theory`
- `theory/probabilistic-theory`
- `theory/online-bandits`
- `theory/active-interactive`
- `theory/domain-adaptation-transfer`
- `theory/theory-other`
...
TERRITORY: theory/dl-theory,theory/learning-theory,theory/rl-planning-theory,theory/optimization-theory,theory/game-theory,theory/probabilistic-theory,theory/online-bandits,theory/active-interactive,theory/domain-adaptation-transfer,theory/theory-other # comma-separated "domain/subdomain" pairs, e.g. # "optimization/convex,optimization/non-convex,optimization/stochastic,optimization/discrete-combinatorial"
TERRITORY_LABEL: theory # short kebab-case slug for branch name, e.g. "opt-cluster-a"
TARGET_NEW_COUNT: 16 # for BATCH-NEW or BATCH-MIXED; target across the whole campaign (8–22 typical; this session caps at 15, deferring any remainder via Step 2.5 + 6.5)
...
RUN_ID: 2026-05-20T08-15-d4e71a # YYYY-MM-DDTHH-MM-RAND6 (UTC, hyphens, no colons — Windows-safe)
