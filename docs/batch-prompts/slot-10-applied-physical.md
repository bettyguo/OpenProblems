# Slot 10 — applied-physical (BATCH-MIXED)
...
| Curator      | `jikun`                                                                     |
| RUN_ID       | `2026-05-20T05-42-3a4d70`                                                   |
| Branch       | `curate/BATCH-MIXED-applied-physical-2026-05-20T05-42-3a4d70`               |

**Subdomains the session may author into:**

- `applications/chem-phys-earth`
- `applications/energy`
- `applications/time-series`

**Existing slugs to deep-research-update (if any):**

- `operator-learning-foundation-models`
...
RUN_ID: 2026-05-20T05-42-3a4d70 # YYYY-MM-DDTHH-MM-RAND6 (UTC, hyphens, no colons — Windows-safe)
