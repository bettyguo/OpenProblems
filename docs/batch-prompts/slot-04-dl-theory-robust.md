# Slot 04 — dl-theory-robust (BATCH-NEW)
...
| Updates      | (none)                                                                 |
| Curator      | `jikun`                                                                |
| RUN_ID       | `2026-05-20T08-55-d4f6a8`                                              |
| Branch       | `curate/BATCH-NEW-dl-theory-robust-2026-05-20T08-55-d4f6a8`            |

**Subdomains the session may author into:**

- `deep-learning/theory`
- `deep-learning/robustness`
- `deep-learning/dl-other`
...
TERRITORY: deep-learning/theory,deep-learning/robustness,deep-learning/dl-other # comma-separated "domain/subdomain" pairs, e.g. # "optimization/convex,optimization/non-convex,optimization/stochastic,optimization/discrete-combinatorial"
TERRITORY_LABEL: dl-theory-robust # short kebab-case slug for branch name, e.g. "opt-cluster-a"
...
RUN_ID: 2026-05-20T08-55-d4f6a8 # YYYY-MM-DDTHH-MM-RAND6 (UTC, hyphens, no colons — Windows-safe)
