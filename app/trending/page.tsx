...
export default function TrendingPage() {
  // Window-filter to last N days; the loader anchors to the most-recent action.
  const windowed = recentRatingActions(DEFAULT_WINDOW_DAYS);

  // For each windowed action, find its chronological predecessor across ALL
  // (unwindowed) actions on the same problem — the prior may sit outside the
  // window, but the diff vs that prior is what makes the row meaningful.
